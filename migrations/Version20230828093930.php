 ...
 */
final class Version20230828093930 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE collection_nft DROP FOREIGN KEY FK_714EE958A76ED395');
        $this->addSql('DROP INDEX IDX_714EE958A76ED395 ON collection_nft');
        $this->addSql('ALTER TABLE collection_nft DROP user_id');
    }
}
